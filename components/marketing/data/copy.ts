...
export const copy: Record<Locale, CopyData> = {
  en: {
    ...
    roadmapNow: 'Public beta: GPT 5.5 supply, multimodal knowledge assets, observability',
    roadmapNext: 'V0.2.9: import/export, failed chunk retry, Agent context upgrades',
    finalTitle: 'Join the Clouisle public beta.',
    finalBody: 'V0.2.9 is open for broader testing, with unlimited GPT 5.5 access and new upgrades across knowledge, Agent workflows, import/export, and admin observability.',
    finalPrimary: 'Join Public Beta',
  ...
  zh: {
    ...
    releaseAnnouncement: {
      eyebrow: 'V0.2.9 已发布',
      title: '云屿全面开放公测，无限量 GPT 5.5 供应。',
      body:
        '本次发布带来多模态知识库资产、配置导入导出、后台可观测性、Agent 编排上下文增强，以及更稳定的对话体验，现已进入全面公开测试。',
      items: ['全面公开测试', '无限量 GPT 5.5 供应', '知识库、Agent 与工作流能力升级'],
    },
    title: 'Clouisle',
    ...
    heroImageAlt: '云屿管理面板',
    stats: [
      { value: 'V0.2.9', label: '全面公开测试' },
      { value: 'GPT 5.5', label: '无限量公测供应' },
    ...
    useCaseEyebrow: '应用场景',
    roadmapTitle: '发布重点',
    roadmapNow: '公测：GPT 5.5 供应、多模态知识库、可观测性',
    roadmapNext: 'V0.2.9：导入导出、失败片段重试、Agent 上下文增强',
    finalTitle: '参与云屿全面公测。',
    finalBody: 'V0.2.9 已面向更大范围开放测试，提供无限量 GPT 5.5 供应，并升级知识库、Agent 工作流、导入导出与后台可观测性。',
    finalPrimary: '参与公测',
    finalSecondary: '联系我们',
  },
};
